...
```text
รับค่าinputเข้ามาเป็นจำนวนเต็มสองค่า(วันและเดือน) จากนั้นให้หาว่าตอนนี้เป็นฤดูอะไร โดยมีเงื่อนไขว่าตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัวฤดูจะเลื่อนไป 1 ฤดู
```
...
```text
รับค่าinputที่เป็นจำนวนเต็มเข้ามาสองค่า ค่านึงเป็นเดือนและอีกค่าเป็นวัน และก็ตั้ง list ของแต่ละเดือนไว้วาเดือนไหนฤดูไหน จากนั้นก็ตรวจสอบตามเงื่อนไข ถ้าเข้าเงื่อนไขแรกก็จะมี output เป็น ฤดูนั้นๆ  แต่ถ้าไม่เข้าเงื่อนไขแรกก็จะดูเงื่อนไขตามที่โจทย์กำหนด จากนั้น output ออกมาเป็นเดือนนั้นๆ
```
...
```text
ใช้วิธีเดียวกับแผนแรก แต่มีการแก้ไขตรงเงื่อนไขเล็กน้อย โดยใช้การหารหาเศษ ถ้าไม่หาร 3 และวันที่ไม่มากกว่าหรือเท่ากับ 21 
```
...
```text
เช็คกรณีที่ไม่เข้าเงื่อนไขหาร 3 กับเลขมากกว่าเท่ากับ 21
```
...
```text
เช็คกรณีที่เข้าเงื่อนไขหาร 3 กับเลขมากกว่าเท่ากับ 21
```
...
```text
เช็คกรณีที่เข้าเงื่อนไขหาร 3 แต่ไม่เข้าเงื่อนไขเลขมากกว่าเท่ากับ 21
```
